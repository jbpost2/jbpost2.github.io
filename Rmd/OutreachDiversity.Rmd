...
I taught six guest lectures around the ideas of using a model to predict, including quantifying quality of predictions using loss functions and how calculus is important to those ideas. The methods we focused on were multiple linear regression and k-nearest neighbors.  In the end we had the students break into teams and compete in a kaggle competition (inactive one but still a great experience). It was a great experience and we hope to continue with similar collaborations.

You can find [information about the material presented here](https://github.com/jbpost2/caryAcademy).
